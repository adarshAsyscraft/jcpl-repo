...
import { deleteUser, fetchAllUsers, searchUsers } from "../../../Redux/slices/allUserSlice";
...
const handleEdit = (record) => {
  ...
  return (
         <Fragment>
           ...
           <Card 
              ...
              extra={
                <Space>
                  ...
                  <Button
                    ...
                    onClick={() => navigate(`${process.env.PUBLIC_URL}/dashboard/users/add/${layoutURL}`)}
                  >
                    + Add User
                  </Button>
                </Space>
            ...
            />
              ...
              <Modal title="User Details" open={viewModal} onCancel={handleClose} footer={[
                    ...
                    {Object.entries(selectedUser)
                      ...
                      .map(([key, value]) => (
                        <div key={key} className="col-md-6 mb-2">
                          <strong className="">{key.replace(/([A-Z])/g, ' $1').trim()}:</strong> {String(value)}
                        </div>
                      ))}
                  </div>
                </div>
        ...
        <EditModal category={editUser} editModal={editModal} setEditModal={setEditModal} />
