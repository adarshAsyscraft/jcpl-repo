...
import GymOwnerRegister from '../Auth/GymOwnerRegister';
import TrainerRegister from '../Auth/TrainerRegister';

export const authRoutes = [
  { path: `${process.env.PUBLIC_URL}/login`, Component: <Logins /> },
  { path: `${process.env.PUBLIC_URL}/register`, Component: <Register /> },
  { path: `${process.env.PUBLIC_URL}/gym_owner/register`, Component: <GymOwnerRegister /> },
  { path: `${process.env.PUBLIC_URL}/trainer/register`, Component: <TrainerRegister /> },
